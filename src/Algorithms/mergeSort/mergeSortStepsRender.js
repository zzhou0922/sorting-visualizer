// We get the sortSteps from getMergeSortSteps function (which within the same folder).
...
// and the color array changing during the merge sort process (in getMergeSortSteps).
...
const mergeSortStepsRender = async(sortSteps, setNumArr, setColorArr, 
									shouldStop, delay) => {
...
export default mergeSortStepsRender;
